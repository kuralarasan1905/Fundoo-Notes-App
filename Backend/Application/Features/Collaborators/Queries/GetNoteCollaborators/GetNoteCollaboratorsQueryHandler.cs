...
{
    public class GetNoteCollaboratorsQueryHandler : IRequestHandler<GetNoteCollaboratorsQuery, List<CollaboratorDto>>
    {
        private readonly ICollaboratorRepository _collaboratorRepository;
        private readonly INoteRepository _noteRepository;
        private readonly IMapper _mapper;

        public GetNoteCollaboratorsQueryHandler(
        ...
        public async Task<List<CollaboratorDto>> Handle(GetNoteCollaboratorsQuery request, CancellationToken cancellationToken)
        {
