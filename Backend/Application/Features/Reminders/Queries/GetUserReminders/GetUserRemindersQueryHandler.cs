...
{
    public class GetUserRemindersQueryHandler : IRequestHandler<GetUserRemindersQuery, List<NoteReminderDto>>
    {
        ...
        public async Task<List<NoteReminderDto>> Handle(GetUserRemindersQuery request, CancellationToken cancellationToken)
        {
