        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Permission = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "Read"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Collaborators_NoteId_UserId",
                table: "Collaborators",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notes_IsTrashed",
                table: "Notes",
                column: "IsTrashed");

            migrationBuilder.CreateIndex(
                name: "IX_Notes_ReminderDateTime",
                table: "Notes",
